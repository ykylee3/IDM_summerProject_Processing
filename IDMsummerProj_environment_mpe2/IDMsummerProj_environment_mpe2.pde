...
//java -jar mpeServer.jar -verbose -framerate30 -screens3
...
//attractor
Attractor[][] attractors = new Attractor[4][200];
...
void settings() {
  ...
  client = new TCPClient(this, "mpe2.xml");
...
void frameEvent(TCPClient c) {
  ...
  if (c.messageAvailable()) {
    //for testing with keyboard events
    //get signals from the globes and Kinect
    int msg = int(c.getDataMessage()[0]);
    inputSignal(msg);
  }
}
